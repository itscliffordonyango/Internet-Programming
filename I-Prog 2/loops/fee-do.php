<?php
// fee-do.php - Calculates expected fees for the next seven consecutive semesters using a do-while-loop.
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($fee1_raw === null || $fee1_raw === '' || !is_numeric($fee1_raw)) {
    ...
    if ($fee1 < 0) {
      ...
      $i = 1; // compute Semester 2..Semester 8 (7 semesters)
      do {
...
<head>
  ...
  <title>Fee Increment Result - Do While Loop</title>
  <style>
...
<body>
  <div class="card">
    <h2>Fee Increment Result (Do While Loop)</h2>
    ...
    <a class="btn" href="fee-do.html">Back</a>
  </div>
</body>
</html>
