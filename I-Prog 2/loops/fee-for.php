<?php
// fee-for.php - Calculates expected fees for the next seven consecutive semesters using a for-loop.
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($fee1_raw === null || $fee1_raw === '' || !is_numeric($fee1_raw)) {
    ...
    if ($fee1 < 0) {
      ...
      // Next seven consecutive semesters: Semester 1..Semester 7? (Most common interpretation)
      // The question asks for the next seven consecutive semesters after semester one.
      // That means compute Semester 2..Semester 8 (7 semesters).
      for ($i = 1; $i <= 7; $i++) {
...
<head>
  ...
  <title>Fee Increment Result - For Loop</title>
  <style>
...
<body>
  <div class="card">
    <h2>Fee Increment Result (For Loop)</h2>
    ...
    <a class="btn" href="fee-for.html">Back</a>
  </div>
</body>
</html>
